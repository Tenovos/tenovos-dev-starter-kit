...
SECRET_POLICY_STRING="{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Principal\":{\"AWS\":\"arn:aws:sts::$NUMERIC_AWS_ACCT_ID:assumed-role/dsk-role-$CUSTOMER_ID-$CUSTOMER_NAME-$DISAMBIGUATOR/dsk-function-$CUSTOMER_ID-$CUSTOMER_NAME-$DISAMBIGUATOR\"},\"Action\":\"secretsmanager:GetSecretValue\",\"Resource\":\"*\"}]}"
